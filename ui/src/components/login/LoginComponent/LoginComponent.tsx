...
export class LoginComponent extends React.Component<{}, State> {
  ...
  async getJWT() {
    ...
    this.authApi.getJWT(l).then(token => {
          ...
          <Segment padded='very' stacked className={styles.Container}>
            ...
            <Segment raised color='teal'>
              <Form onSubmit={this.handleSubmit}>
                <Form.Field label='Username' control={Input} onChange={this.setUsername}/>
                <Form.Input label='Password' control={Input} type='password' onChange={this.setPassword}/>
